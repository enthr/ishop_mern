...
const ProductScreen = () => {
    ...
    return (
        <>
            <Link className='btn btn-primary my-4' to='/'>Go Back</Link>
                        ...
                        <Col md={3}>
                            <Card>
                                <ListGroup variant='flush'>
                                    ...
                                    <ListGroup.Item>
                                        <Row className='p-2'>
                                            <Button onClick={addToCartHandler} variant='primary' type='button' disabled={product.countInStock === 0}>Add To Cart</Button>
                                        </Row>
                                    </ListGroup.Item>
                                </ListGroup>
                            </Card>
