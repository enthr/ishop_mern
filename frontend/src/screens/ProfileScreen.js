...
import { getOrdersListUser } from '../actions/orderActions';
...
const ProfileScreen = () => {
    ...
    const { loading:orderListLoading, error:orderListError, orders } = orderListUser;
                                ...
                                <tr key={order._id}>
                                    ...
                                    <td>
                                        <LinkContainer to={`/order/${order._id}`}>
                                            <Button variant='btn btn-primary'>Details</Button>
                                        </LinkContainer>
                                    </td>
                                </tr>
                            ))}
